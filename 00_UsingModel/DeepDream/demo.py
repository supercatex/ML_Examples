...
""" Variables """
# base images path and result prefix
### TODO: use argparse
base_image_path = 'CheshireCat.jpg'
result_prefix = 'images/CheshireCat'
...
# util function to convert a tensors into a valid images
...
# continuity loss: to give the images local coherence and avoid messy blurs
...
# this will contain the generated images
...
# add continuity loss (to give the images local coherence and avoid messy blurs)
loss += settings['continuity'] * continuity_loss(dream) / np.prod(img_size)

# add images L2 norm to loss (prevents pixels from taking very high values)
...
# run L-BFGS optimizer over the pixels of the generated images,
...
for i in range(20):
    ...
    # add a random jitter to the initial images; this will be reverted at decoding time
